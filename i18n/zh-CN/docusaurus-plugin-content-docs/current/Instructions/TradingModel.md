...
2. ExinOne 的 USDT 被卖空了（都转给了用户），会出现[延迟放币](/Instructions/DelayedRelease)的情况，待 USDT 补充完毕，您就可以收到 USDT 了。
...
所以，在一定条件下，您可能会遇到 [延迟放币](/Instructions/DelayedRelease) 的情况，请您耐心等待，提币正在路上了。
...
提到这些，首先我们需要了解交易账户的具体介绍，请看[这篇文章](/Features/TradingAccount)，里面讲述了交易账户的作用：
...
这就是「[交易账户](/Features/TradingAccount)」要解决的问题：
